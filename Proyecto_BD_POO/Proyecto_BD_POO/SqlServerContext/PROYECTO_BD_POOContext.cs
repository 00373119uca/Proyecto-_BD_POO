...
{
    public partial class PROYECTO_BD_POOContext : DbContext
    {
        public PROYECTO_BD_POOContext()
        {
        }

        public PROYECTO_BD_POOContext(DbContextOptions<PROYECTO_BD_POOContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=LAPTOP-PHG1MDLN;Database=PROYECTO_BD_POO;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cabin>(entity =>
            {
                entity.HasKey(e => e.CabinNumber)
                    .HasName("PK__CABIN__243A3277CAE9CE24");
            ...
            modelBuilder.Entity<Citizen>(entity =>
            {
                entity.HasKey(e => e.Dui)
                    .HasName("PK__CITIZEN__C0317D9041FFFCD0");
