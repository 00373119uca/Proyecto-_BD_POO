...
namespace Proyecto_BD_POO.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CABIN__243A3277CAE9CE24", x => x.Cabin_number);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__CITIZEN__C0317D9041FFFCD0", x => x.Dui);
                    table.ForeignKey(
