...
{
    [DbContext(typeof(PROYECTO_BD_POOContext))]
    partial class PROYECTO_BD_POOContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.Cabin", b =>
                {
                    b.Property<int>("CabinNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.Citizen", b =>
                {
                    b.Property<int>("Dui")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.Disease", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.Employee", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.Position", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.Registry", b =>
                {
                    b.Property<int>("CabinNumber")
                        .HasColumnType("int")
                        .HasColumnName("Cabin_number");
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.SecondaryEffect", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.TypeEmployee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.VaccinationProcess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.Appointment", b =>
                {
                    b.HasOne("Proyecto_BD_POO.SqlServerContext.Cabin", "CabinNumberNavigation")
                        .WithMany("Appointments")
                        .HasForeignKey("CabinNumber")
                        .HasConstraintName("FK_Cabin_number");

                    b.HasOne("Proyecto_BD_POO.SqlServerContext.Citizen", "DuiCitizenNavigation")
                        .WithMany("Appointments")
                        .HasForeignKey("DuiCitizen")
                        .HasConstraintName("FK_Dui_citizen");

                    b.HasOne("Proyecto_BD_POO.SqlServerContext.Employee", "IdEmployeeNavigation")
                        .WithMany("Appointments")
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.Citizen", b =>
                {
                    ...
                    b.HasOne("Proyecto_BD_POO.SqlServerContext.Position", "IdPositionNavigation")
                        .WithMany("Citizens")
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.Employee", b =>
                {
                    b.HasOne("Proyecto_BD_POO.SqlServerContext.TypeEmployee", "IdTypeEmployeeNavigation")
                        .WithMany("Employees")
            ...
            modelBuilder.Entity("Proyecto_BD_POO.SqlServerContext.SecondaryEffect", b =>
                {
                    b.HasOne("Proyecto_BD_POO.SqlServerContext.VaccinationProcess", "IdProcessNavigation")
